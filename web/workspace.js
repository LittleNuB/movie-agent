...
export const kinds={proposal:'故事提案',script:'剧本',visual_plan:'视觉方案',shot_plan:'镜头计划',edit_plan:'修改方案',continuity_check:'媒体观察',image:'图片',video:'镜头',audio:'声音',native_mixed:'原生混音',trial:'试拍',film:'影片',picture_master:'画面母版'};
