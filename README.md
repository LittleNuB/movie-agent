...
| 前端视觉 | A 日间、B 夜间；用户已选03「显影」Logo，SVG已接入侧栏、欢迎页、导演头像与favicon，见[接入记录](./docs/plans/ui-visual-polish.md) |
...
| 前期制作工程 | 已实现制作说明、参考清单、镜头输入与有声分镜预演；两组真实文字验证、参考图派生及8秒预演已有产物。参考遗漏、剧本逻辑与实际质量仍有缺口，见[真实验证](./docs/validation/preproduction-live-2026-09-09.md) |
