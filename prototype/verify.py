...
with sync_playwright() as pw:
    ...
    page.locator('#api-name').fill('示例连接')
    page.locator('#api-url').fill('https://api.example.com/v1')
    page.locator('#api-key').fill('DEMO-ONLY-NOT-A-KEY')
    page.locator('[data-api="check"]').click()
